// code to get Puppet repo names 
// need to run in msr19/source for dependencies 
const BigQuery = require('@google-cloud/bigquery');
var fs = require('fs');

const projectId = "githubsolidityquery";
const sqlQuery = 'SELECT * FROM `LOL.TSE_PUPPET_GITHUB_REPOS`' ; 

var out_fil = 'ICSE_GITHUB_PUPPET_REPO_NAMES.csv'
...
bigquery
  ...
  .then(results => {
    ...
    if(err) {
        ...
        console.log("Puppet Github repo names dumped succesfully ... ");
    }); 
